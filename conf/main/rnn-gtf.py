...
variants = {
    'v1': {"path_to_data": "data/rnn/rnn.v1.train.npy", "observation_model": "Identity", "latent_dim": 8, "hidden_dim": 256},
    'v2': {"path_to_data": "data/rnn/rnn.v2.train.npy", "observation_model": "Affine",   "latent_dim": 8, "hidden_dim": 256},
}
